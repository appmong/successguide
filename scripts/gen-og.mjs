...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <defs><linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
    <stop offset="0" stop-color="#ffffff"/><stop offset="1" stop-color="#f0ebff"/>
  </linearGradient></defs>
  <rect width="1200" height="630" fill="url(#bg)"/>
  <rect x="0" y="0" width="1200" height="12" fill="#6d28d9"/>
  <rect x="90" y="86" width="72" height="72" rx="18" fill="#6d28d9"/>
  <path d="M105 139 L147 105 M126 105 L147 105 L147 126" fill="none" stroke="#ffffff" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <text x="94" y="556" font-family="${FONT}" font-size="26" font-weight="700" fill="#6d28d9">${esc(HOST)}</text>
</svg>`;
...
const iconSvg = readFileSync(resolve(root, "public/favicon.svg"));
await sharp(iconSvg, { density: 400 }).resize(180, 180).png().toFile(resolve(root, "public/apple-touch-icon.png"));
await sharp(iconSvg, { density: 400 }).resize(512, 512).png().toFile(resolve(root, "public/logo.png"));
